...
const routes: Routes = [{path: '', redirectTo: 'home', pathMatch: 'full'},
  ...
  {path: 'subject', component: SubjectComponent, data: {breadcrumb: '科目'}},
      {path: 'addSubject', component: SubjectFormComponent, data: {breadcrumb: '新增科目'}},
      {path: 'teacher', component: TeacherComponent, data: {breadcrumb: '教师'}},
      {path: 'addTeacher', component: TeacherFormComponent, data: {breadcrumb: '新增教师'}},
      ...
      {path: 'addClass', component: ClassFormComponent, data: {breadcrumb: '新增班级'}},
      {path: 'courseTeacher/:id/:grade', component: CourseTeacherComponent, data: {breadcrumb: '课程及任课老师'}},
      {path: 'student', component: StudentComponent, data: {breadcrumb: '学生'}},
      {path: 'addStudent', component: StudentFormComponent, data: {breadcrumb: '新增学生'}},
